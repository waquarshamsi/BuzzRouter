...
public class EmailNotificationService implements NotificationService {
    ...
    public void send(NotificationRequest request) {
        log.info("Attempting to send email to: {}", request.getRecipientIdentifier());
    ...
    @Recover
    public void recover(MailException e, NotificationRequest request) {
        log.error("All retries failed for sending email to: {}. Final error: {}", request.getRecipientIdentifier(), e.getMessage());
