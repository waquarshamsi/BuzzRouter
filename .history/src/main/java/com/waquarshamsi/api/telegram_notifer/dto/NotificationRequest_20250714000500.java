...
public class NotificationRequest {
    ...
    @NotEmpty(message = "Recipients map cannot be empty")
    private Map<NotificationTarget, String> recipients; // e.g., { "EMAIL": "user@example.com", "TELEGRAM": "12345678" }
    ...
    public Map<NotificationTarget, String> getRecipients() { return recipients; }
    public void setRecipients(Map<NotificationTarget, String> recipients) { this.recipients = recipients; }
    ...
    public Optional<String> getCorrelationId() {
        return Optional.ofNullable(metadata)
                .map(m -> m.get(CORRELATION_ID_KEY));
    }
