...
public class TelegramNotificationService implements NotificationService {
    ...
    public void send(NotificationRequest request) {
        log.info("Attempting to send Telegram message to chat ID: {}", request.getRecipientIdentifier());
    ...
    @Recover
    public void recover(RuntimeException e, NotificationRequest request) {
        log.error("All retries failed for sending Telegram message to chat ID: {}. Final error: {}", request.getRecipientIdentifier(), e.getMessage());
